...
### Investigation & IK Validation

Detailed investigation docs, IK validation scripts, GPU verification guide,
and remaining blockers are in
[`docs/rby1_freeze_saltshaker_custom_scene/`](docs/rby1_freeze_saltshaker_custom_scene/).
