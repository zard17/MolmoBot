...
EPISODE_CONFIGS = [
    ...
    },
    {
        ...
        "object_body_name": SALT_SHAKER_BODY_NAME,
        "object_path": SALT_SHAKER_PATH,
        "pickup_pos": [0.50, 0.25, 0.79, 0.7071068, 0.7071068, 0, 0],
        "goal_pos":   [0.50, 0.25, 0.99, 0.7071068, 0.7071068, 0, 0],
        "task_desc": "Pick up the salt shaker",
    },
    {
        "object_name": "salt shaker",
        ...
        "object_body_name": SALT_SHAKER_BODY_NAME,
        "object_path": SALT_SHAKER_PATH,
        "pickup_pos": [0.45, 0.32, 0.79, 0.7071068, 0.7071068, 0, 0],
        "goal_pos":   [0.45, 0.32, 0.99, 0.7071068, 0.7071068, 0, 0],
        "task_desc": "Pick up the salt shaker",
    },
    {
        "object_name": "salt shaker",
        ...
        "object_body_name": SALT_SHAKER_BODY_NAME,
        "object_path": SALT_SHAKER_PATH,
        "pickup_pos": [0.50, 0.32, 0.79, 0.7071068, 0.7071068, 0, 0],
        "goal_pos":   [0.50, 0.32, 0.99, 0.7071068, 0.7071068, 0, 0],
        "task_desc": "Pick up the salt shaker",
    },
    {
        "object_name": "salt shaker",
        ...
        "object_body_name": SALT_SHAKER_BODY_NAME,
        "object_path": SALT_SHAKER_PATH,
        "pickup_pos": [0.52, 0.32, 0.79, 0.7071068, 0.7071068, 0, 0],
        "goal_pos":   [0.52, 0.32, 0.99, 0.7071068, 0.7071068, 0, 0],
        "task_desc": "Pick up the salt shaker",
    },
    {
        "object_name": "salt shaker",
        ...
        "object_body_name": SALT_SHAKER_BODY_NAME,
        "object_path": SALT_SHAKER_PATH,
        "pickup_pos": [0.50, 0.35, 0.79, 0.7071068, 0.7071068, 0, 0],
        "goal_pos":   [0.50, 0.35, 0.99, 0.7071068, 0.7071068, 0, 0],
        "task_desc": "Pick up the salt shaker",
    },
]
