"""Smoke test script — runs setup + 3 smoke tasks (5 steps each)."""
import os
import sys
...
Image.fromarray(stacked_img).save("smoke_render.png")
print("Saved smoke_render.png")

# --- Load Model ---
print("Loading MolmoBot-DROID model (may download ~8GB on first run)...")
...
# --- Smoke Tests ---
print("\n" + "="*60)
print("SMOKE TESTS — 5 steps each, ~2 min per task")
print("="*60)
